      ...
      <form action="https://formsubmit.co/info@thewanderlustcr.com" method="POST">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
            ...
            <div class="form-group">
              <input type="date" class="form-control" name="Date" id="Date" placeholder="Drop off" data-rule="date"  data-msg="Please enter a valid date" required/>
              <div class="validation"></div>
            </div>

       <div class="text-center" id="confirmacion"><button type="submit" class="btn btn-primary btn-lg">confirmation</button></div>
    </form>
      <!--/.row-->
    </div>
    <!--/.container-->
