  ...
  taskForm.innerHTML =`<div class="row">
      <div class="col-md-8 ">
        <div class="portfolios">
          ...
          <hr>
               <div class="text-center">
        <a class="btn btn-primary btn-lg" href="Español/Contacto.html">Reservar</a>
      </div>
        </div>
      </div>
       <div class="col-md-4 ">
      ...
      <div class="col-md-6 col-md-offset-3">
        <div class="text-center">
          <h2>One and Half day tours</h2>
            ...
            <p>
              <br>El 4% de impuesto al valor agregado (IVA), debe sumarse a todas las tarifas<br> Desde Julio 2021 hasta Julio 2022<br><strong>Click en el nombre para conocer mas del tour.<strong>.
          </p>
        </div>
        <hr>
      </div>
